...
{
////////////////////////////////////////////////////////////
bool InputImplX11::isKeyPressed(Keyboard::Key key)
{
...
////////////////////////////////////////////////////////////
void InputImplX11::setVirtualKeyboardVisible(bool /*visible*/)
{
    // Not applicable
}
...
////////////////////////////////////////////////////////////
bool InputImplX11::isMouseButtonPressed(Mouse::Button button)
{
    // Open a connection with the X server
    Display* display = OpenX11Display();
...
////////////////////////////////////////////////////////////
Vector2i InputImplX11::getMousePosition()
{
    // Open a connection with the X server
    Display* display = OpenX11Display();
...
////////////////////////////////////////////////////////////
Vector2i InputImplX11::getMousePosition(const WindowBase& relativeTo)
{
...
////////////////////////////////////////////////////////////
void InputImplX11::setMousePosition(const Vector2i& position)
{
    // Open a connection with the X server
    Display* display = OpenX11Display();
...
////////////////////////////////////////////////////////////
void InputImplX11::setMousePosition(const Vector2i& position, const WindowBase& relativeTo)
{
    // Open a connection with the X server
    Display* display = OpenX11Display();
...
////////////////////////////////////////////////////////////
bool InputImplX11::isTouchDown(unsigned int /*finger*/)
{
    // Not applicable
    return false;
}
...
////////////////////////////////////////////////////////////
Vector2i InputImplX11::getTouchPosition(unsigned int /*finger*/)
{
    // Not applicable
    return Vector2i();
}
...
////////////////////////////////////////////////////////////
Vector2i InputImplX11::getTouchPosition(unsigned int /*finger*/, const WindowBase& /*relativeTo*/)
{
    // Not applicable
    return Vector2i();
}
