...
#ifndef SFML_GLCONTEXTWAYLAND_HPP
#define SFML_GLCONTEXTWAYLAND_HPP
...
///
////////////////////////////////////////////////////////////
class GlContextWayland : public GlContext
{
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    GlContextWayland(GlContextWayland* shared);
    ...
    ///
    ////////////////////////////////////////////////////////////
    GlContextWayland(GlContextWayland* shared, const ContextSettings& settings, const WindowImpl* owner, unsigned int bitsPerPixel);
    ...
    ///
    ////////////////////////////////////////////////////////////
    GlContextWayland(GlContextWayland* shared, const ContextSettings& settings, unsigned int width, unsigned int height);
...
//    void updateSettingsFromWindow();
    ...
    ///
    ////////////////////////////////////////////////////////////
    void createSurface(GlContextWayland* shared, unsigned int width, unsigned int height, unsigned int bitsPerPixel);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void createSurface(struct wl_egl_window* window);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void createContext(GlContextWayland* shared);

    ////////////////////////////////////////////////////////////
    // Member data
    ////////////////////////////////////////////////////////////
    WaylandDisplay*        m_display;    ///< Connection to the X server
    EGLSurface        m_surface;
    EGLContext        m_context;    ///< OpenGL context
    EGLConfig         m_ctx_config; ///< Config associated with context
...
#endif // SFML_GLCONTEXTWAYLAND_HPP
